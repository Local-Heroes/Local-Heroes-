  ...
  return (
    <div className="flex flex-col items-center mt-8 min-h-screen bg-gray-50 px-4">
      ...
      <div className="w-full max-w-md mb-4">
        <Link
          to="/"
          className="flex items-center text-lg font-bold text-orange-500 hover:underline"
        >
          ← Back to Heroes
        </Link>
      </div>
      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-md p-8  sm:h-auto">
        ...
        <p className="text-center text-gray-500 text-sm mb-6">
          Create an account to start thanking heroes and sharing your appreciation
        </p>
        ...
        <p className="text-red-500 text-sm mb-4">{error}</p>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-3 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r
             from-orange-500 to-red-500 text-white py-2 
